              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  final filteredAnimals = allAnimals.where((animal) {
                    final matchesSearch = animal.name.toLowerCase().contains(_searchQuery);
                    
                    // Filter matching selected Deck classification
                    bool matchesDeck = false;
                    if (_selectedDeck == 'All') {
                      matchesDeck = true;
                    } else {
                      final b = animal.breed.toLowerCase();
                      final d = _selectedDeck.toLowerCase();
                      if (b == d) {
                        matchesDeck = true;
                      } else {
                        // Fallbacks mapping legacy breed entries
                        if (d == 'avian') {
                          matchesDeck = b.contains('duck') || b.contains('chicken') || b.contains('quail') || b.contains('avian');
                        } else if (d == 'pets') {
                          matchesDeck = b.contains('dog') || b.contains('cat') || b.contains('rabbit') || b.contains('pets');
                        } else if (d == 'livestock') {
                          matchesDeck = b.contains('pig') || b.contains('goat') || b.contains('cow') || b.contains('livestock');
                        } else if (d == 'aquatic') {
                          matchesDeck = b.contains('fish') || b.contains('shrimp') || b.contains('aquatic');
                        }
                      }
                    }
